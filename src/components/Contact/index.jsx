    ...
    >
      <div className="text">
        ...
        Feel free to reach out me via{" "}
          <a
            href="mailto:jatinshivlani272@gmail.com"
            target="_blank"
      ...
      <div className="flex flex-col py-2 mb-5 w-full space-y-6 items-center justify-center">
        <div className="divide-x divide-solid divide-white/50 grid grid-cols-3 w-full">
          ...
          >
            <AiOutlineMail className="social-icon h-7 w-7 sm:h-8 sm:w-8 xl:h-9 xl:w-9 2xl:h-10 2xl:w-10" />
          </a>
          <a
            href="https://github.com/JatinShivlani"
            target="_blank"
